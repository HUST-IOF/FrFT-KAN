...
import pandas as pd
from mag_frft_kan import FRFTNet

# Defining the FRFT angles
frft_angles = [0.1, 0.3, 0.5]  # Specify the FRFT angles you want to use
...
for angle in frft_angles:
    ...
    for trial in range(trials):
        ...
        for epoch in range(epochs_per_trial):
            ...
            for images, labels in trainloader:
                ...
                images_no_dc = images - mean
                labels = labels.to(device)
                optimizer.zero_grad()
                outputs = model(images_no_dc)
    ...
    # Saving the results
    # Saving the results to an Excel file named after the FRFT angle
    file_name = f'MAG_FRFT_{angle}_results.xlsx'
